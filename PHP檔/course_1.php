        ...
        <div class="row">
            <div class="col-12 offset-lg-1 col-lg-10">
                <div class="featured-image">
                    <img src="images/single-course-featured-img.jpg" alt=""width=900px>
                </div>
            </div><!-- .col -->
        </div><!-- .row -->
                    ...
                    <div class="course-info flex flex-wrap align-items-center">
                        <div class="course-author flex flex-wrap align-items-center mt-3">
                            ...
                            <div class="author-wrap">
                                ...
                                <div class="author-name"><a href="#">于天立</a></div>
                            </div><!-- .author-wrap -->
                        </div><!-- .course-author -->
                        <div class="course-students mt-3">
                            <label class="m-0">單位</label>
                            <div class="author-name"><a href="#">台灣大學電機系</a></div>
                        </div><!-- .course-students -->
                        ...
                        <button type="button"><a href="http://ocw.aca.ntu.edu.tw/ntu-ocw/ocw/cou/101S210" style="color: black">前往課程</a></button>
                        </div><!-- .buy-course -->
                    </div><!-- .course-info -->
