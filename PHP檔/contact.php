        ...
        <div class="row justify-content-between">
            ...
            <div class="col-12 col-lg-6">
                <div class="contact-form">
                    ...
                    <form>
                        ...
                        <input type="email" placeholder="你的信箱">
                        <input type="text" placeholder="想學課程">
                        <textarea placeholder="想對我們說什麼？" rows="4"></textarea>
            ...
            <div class="col-12 col-lg-6">
                <div class="contact-info">
                    ...
                    <ul class="p-0 m-0">
                        <li><span>地點:</span>輔仁大學伯達樓6F</li>
                        <li><span>Email:</span><a href="#">justkiddingyou@gmail.com</a></li>
