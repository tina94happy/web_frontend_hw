                    ...
                    <div class="row mx-m-25">
                        <div class="col-12 col-md-6 px-25">
                            <div class="course-content">
                                ...
                                <div class="course-content-wrap">
                                    <header class="entry-header">
                                        <h2 class="entry-title"><a href="course_1.html">計算機程式設計</a></h2>

                                        <div class="entry-meta flex flex-wrap align-items-center">
                                            <div class="course-author"><a href="#">國立台灣大學 鄭教授 </a></div>
                                    ...
                                    <footer class="entry-footer flex flex-wrap justify-content-between align-items-center">
                                        ...
                                        <div class="course-ratings flex justify-content-end align-items-center">
                                            ...
                                            <span class="course-ratings-count">(88 votes)</span>
                                        </div><!-- .course-ratings -->
                                    </footer><!-- .entry-footer -->
                        ...
                        <div class="col-12 col-md-6 px-25">
                            <div class="course-content">
                                ...
                                <div class="course-content-wrap">
                                    <header class="entry-header">
                                        <h2 class="entry-title"><a href="course_2.html">資料庫系統概論</a></h2>

                                        <div class="entry-meta flex flex-wrap align-items-center">
                                            <div class="course-author"><a href="#">國立臺灣大學 吳教授</a></div>
